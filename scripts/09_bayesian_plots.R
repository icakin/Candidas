# =============================================================================
# 09_bayesian_plots.R - Figures + contrasts from the Bayesian fits
# =============================================================================
# Reads the models fitted by 08_bayesian_models.R. No refitting.
#
# FIGURES
...
p_resp <- ggplot2::ggplot() +
  ...
  ggplot2::labs(
    ...
    subtitle = "LOO: Arrhenius beats Sharpe-Schoolfield - respiration keeps rising and never peaks",
    x = "Temperature (°C)",
...
p_cue <- ggplot2::ggplot(cue_grp, ggplot2::aes(T, med)) +
  ...
  ggplot2::labs(
    ...
    subtitle = "CUE = G / (G + R), computed draw-by-draw: bounded in [0,1] with a proper credible interval",
...
message("09_bayesian_plots.R done.\n")
