# =============================================================================
# 13_supplementary_figures.R  --  etc-GEM SUPPLEMENTARY FIGURES (diagnostics + validation)
# =============================================================================
# The diagnostics behind 12_main_figures.R, in one supplementary:
...
# =============================================================================
# SUPPLEMENTARY: validation / elimination figure (merged in; formerly 13_supplementary_figures.R)
...
# =============================================================================
# =============================================================================
# 13_supplementary_figures.R  --  SUPPLEMENTARY validation / elimination figure
# =============================================================================
...
FIG <- (fa | fb) / (fc | fd) +
  patchwork::plot_annotation(
    title = "Supplement — the effective growth-capacity axis is a real, clade-level, non-coding, non-transcriptional trait",
