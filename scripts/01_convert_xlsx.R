...
# ---- headless guard --------------------------------------------------------
# This file called runApp() whenever it was NOT interactive, which is
# exactly the case under Rscript. data/*_Oxygen.csv and
# results/tables/otu_names.csv are committed INPUTS to the pipeline.
