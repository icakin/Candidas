# =============================================================================
# 09_bayesian_models.R - Hierarchical Bayesian thermal performance curves (brms)
# =============================================================================
# Fits, saves, and summarises. NO plotting (that is 11_bayesian_plots.R), because
...
message("  Next: 11_bayesian_plots.R (grouped TPC panels, Arrhenius, CUE).")
