# =============================================================================
# 10_n0_term_test.R - Does the between-clade respiration ordering depend on the
...
#
# It re-fits the SAME Bayesian respiration model as 09_bayesian_models.R, twice:
...
#        BAYES_ITER / BAYES_CHAINS in 09_bayesian_models.R first.
...
# RUN  : Rscript scripts/10_n0_term_test.R   (or "Source" in RStudio)
# =============================================================================
