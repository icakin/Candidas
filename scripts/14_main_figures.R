# =============================================================================
# 14_main_figures.R  --  THE THREE MAIN PAPER FIGURES (Fig 1 decoupling, Fig 2 the bill, Fig 3 etc-GEM)
# =============================================================================
#
...
message("\n", strrep("=", 66))
message("14_main_figures.R   Growth = Sharpe-Schoolfield.  Resp = Arrhenius.")
message(strrep("=", 66))
