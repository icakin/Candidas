...
Consequently the genome-derived model (Fig. 3) predicts a single,
essentially identical thermal curve for all four clades, whereas the
measured clades differ roughly two-fold in peak growth (Fig. 4b).
Sequence variation therefore cannot account for the clade differences. A
per-clade calibration nonetheless recovers each measured growth curve
(Fig. 4a).
